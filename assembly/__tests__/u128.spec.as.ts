...
describe("Exponention Operation", () => {
  ...
  it("should Sqrt 64Number", () => {
    var a = new u128(64);
    expect<u128>(u128.sqrt(a)).toStrictEqual(new u128(8));
  });

  it("should Sqrt 1000Number", () => {
    var a = new u128(1000);
